      ...
      <div class="baiviet2">
        <?php foreach ($tintuc as $key => $row) { ?>
          <div class="baiviet2_it" >
            <div class="img">
              <a class="hover_zoom" href="<?=$row['tenkhongdau']?>"><img onerror="this.src='http://placehold.it/560x440'" src="<?=$com=='du-an'?'thumb1':'thumb'?>/560x440/1/<?=_upload_baiviet_l.$row['photo']?>" alt="<?=$row['ten_'.$lang]?>"></a>
            </div>
            <div class="noidung">
